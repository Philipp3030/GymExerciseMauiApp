...
//        // To Model
//        public static async Task<ExerciseIndex> MapToModel(ApplicationDbContext context, ExerciseIndexViewModel exerciseIndexViewModel, Training? training)
//        {
//            // get existing entity
...
//        #region Exercise
//        // To Model
//        public static async Task<Exercise> MapToModel(ApplicationDbContext context, ExerciseViewModel exerciseViewModel, Training? training)
//        {
//            // get existing entity
...
//            {
//                exerciseIndices.Add(await MapToModel(context, exerciseIndex, training));
//            }
...
//                if (existingEntity == null)
//                {
//                    exercises.Add(await MapToModel(context, exercise, training)); 
//                }
//                else
//                {
//                    exercises.Add(await MapToModel(context, exercise, existingEntity));
//                }
//            }
