...
namespace GymExerciseClassLibrary.Migrations
{
    ...
    [Migration("20250817200553_RefactoredExerciseIndex")]
    partial class RefactoredExerciseIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymExerciseClassLibrary.Models.ExerciseIndex", b =>
                {
                    b.HasOne("GymExerciseClassLibrary.Models.Exercise", "Exercise")
                        .WithMany("ExerciseIndices")
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GymExerciseClassLibrary.Models.Training", "Training")
                        .WithMany()
